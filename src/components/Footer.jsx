   ...
   pl-[1.2rem] 2xl:pl-[2.37rem] gap-[2.83rem]"
    >
      <div className="flex justify-center items-center gap-2 2xl:gap-4">
        <img
          className="w-[1.87rem] 2xl:w-12  md:w-10"
          src={vector}
          alt="icon"
        />
        <strong className="font-handlee font-medium text-[1.38rem] md:text-3xl 2xl:text-4xl leading-normal text-shadow shadow-black-200 text-black-200">
          znisa
        </strong>
      </div>
      <div className="flex flex-col items-start 2xl:items-center gap-[0.69rem] 2xl:gap-[2.437rem]">
        <div className="flex gap-[1.37rem] 2xl:gap-[4.81rem]">
          <a
            className="bg-black-200 shadow-[1px_1px_11.2px_0px_rgba(0,0,0,0.08)] text-white text-center text-shadow shadow-white font-handlee text-base md:text-[2rem] font-normal leading-normal"
            href="#"
          >
            Twitter X
          </a>
