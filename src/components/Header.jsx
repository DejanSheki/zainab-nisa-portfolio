    ...
    <header className="flex flex-col pt-16 gap-6">
      <div className="flex p-[0.24944rem_2.11925rem_0.30131rem_0.363rem] items-center">
        <div className="flex items-center gap-4 -rotate-[5.2deg]">
          ...
          <div className="h-16">
            <strong className="font-handlee text-[2rem] text-black-200 bg-pink-100">
              znisa
            </strong>
          </div>
        </div>
      ...
      <div className="flex justify-between gap-52 px-2">
        ...
        <div className="w-1/2 pt-2">
          <p className="font-inter font-normal text-2xl text-black-200 leading-8 text-justify">
            I'll design your website and will develop to land it on internet
            using No-code.
          </p>
          <button className="bg-black-200 shadow-[3px_3px_12px_0px_rgba(0,0,0,0.12)] py-[1.125rem] px-[3.625rem] mt-8 text-white font-inter text-2xl font-semibold hover:shadow-[0px_0px_0px_4px_rgba(255,_201,_240,_1)] hover:text-pink-100">
            Hire me
          </button>
        </div>
      </div>
